<?php
    ...
    //給值
    $statement->bindValue(1, $_POST["googlemail"]);
    $statement->bindValue(2, $_POST["googleid"]);
    $statement->execute();
    ...
    if($memberID == "" && $memberName == ""){
        ...
        $statement->bindValue(2, $_POST["googlename"]);
        $statement->bindValue(3, $_POST["googlename"]);
